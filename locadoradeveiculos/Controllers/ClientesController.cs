...
namespace locadoradeveiculos.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,cnh,nome,idade,endereco,cidade,estado,cep")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,cnh,nome,idade,endereco,cidade,estado,cep")] Cliente cliente)
        {
            if (id != cliente.id)
            {
                return NotFound();
